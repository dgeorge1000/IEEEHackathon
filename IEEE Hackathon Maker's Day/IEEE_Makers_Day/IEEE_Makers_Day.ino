// This code allows for a laser pointer to be turned on and off by a joystick
// The joystick also allows for the laser pointer to move both vertically and horizontally by using 2 motors
